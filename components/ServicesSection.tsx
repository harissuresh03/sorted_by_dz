      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-12">
          ...
          <p className="mt-4 max-w-xl text-lg font-medium text-navy/80 dark:text-white/90">
            Hover to preview a category, click to explore the services inside.
          </p>
        </div>
              ...
              {activeCategory && (
                ...
                >
                  ...
                  <div className="absolute bottom-8 left-8 right-8 text-white">
                    <h3 className="text-4xl md:text-5xl font-bold mb-3">{activeCategory.name}</h3>
                    <p className="text-lg md:text-xl opacity-90 mb-4">{activeCategory.desc}</p>
