    ...
    <div className="mt-14 grid items-start gap-6 md:grid-cols-2 xl:grid-cols-3">
      {categories.map((category) => {
        ...
        <article
          ...
          className="group overflow-hidden rounded-[24px] border border-teal/20 bg-white/80 shadow-[0_18px_50px_rgba(11,19,43,0.08)] transition-transform duration-500 hover:-translate-y-1 dark:border-teal/30 dark:bg-[#101b30]/90"
        >
          ...
          <div className="flex min-h-[220px] flex-col p-6 md:p-7">
            <h2 className="text-2xl font-bold leading-tight text-navy transition-transform duration-500 group-hover:-translate-y-1 dark:text-white md:text-3xl">
            ...
            >
              <div className="min-h-0 overflow-hidden">
                <div className="mt-6 border-t border-teal/15 pt-5 dark:border-teal/25">
