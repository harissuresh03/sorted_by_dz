        ...
        <section className="mx-auto max-w-3xl">
          ...
          <Reveal delay={100}>
            <article className="mt-10 space-y-6 text-navy/85 dark:text-white/90">
              <div>
                <h2 className="text-xl font-bold text-navy dark:text-white">Our role</h2>
                <p className="mt-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-navy dark:text-white">Your request</h2>
                <p className="mt-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-navy dark:text-white">Provider arrangements</h2>
                <p className="mt-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-navy dark:text-white">Changes</h2>
                <p className="mt-3">
